...
import com.shl.crowdfunding.manager.mapper.AdvertMapper;
import com.shl.crowdfunding.manager.service.AdvertService;
...
public class AdvertServiceImpl implements AdvertService {
	...
	public Page<Advert> pageQuery(Map<String, Object> paramMap) {
		...
		paramMap.put("startIndex", advertPage.getStartPage());
