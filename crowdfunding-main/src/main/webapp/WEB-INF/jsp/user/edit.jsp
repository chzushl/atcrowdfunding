                ...
                <div class="panel-body">
                    <form id="updateForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="floginacct" value="${editUser.loginacct}">
                        </div>
                        <div class="form-group">
                            <label for="fusername">用户名称</label>
                            <input type="text" class="form-control" id="fusername" value="${editUser.username}">
                        </div>
                        <div class="form-group">
                            <label for="femail">邮箱地址</label>
                            <input type="email" class="form-control" id="femail" value="${editUser.email}">
...
<script type="text/javascript">
    ...
    $("#updateBtn").click(function () {
        ...
        if($.trim(loginacct)==""){
            layer.msg("用户帐号不能为空,请重新输入", {time:1000, icon:5, shift:6}, function(){
                loginacct.val("");
                loginacct.focus();
            });
            return false;
